...
public class SimpleGUI extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    private void init() {
        ...
        JMenuItem menu2Item1 = new JMenuItem("FAQ");
        JMenuItem menu2Item2 = new JMenuItem("About");
        ...
        //setting up challenge 3
        menuItem1.addItemListener(this);
        menuItem2.addItemListener(this);
        menu2Item1.addItemListener(this);
        menu2Item2.addItemListener(this);

        //setting up checkboxes to use ItemListener interface and itemStateChanged method
        checkBox1.addItemListener(this);
        checkBox2.addItemListener(this);

        //seting up challenge 4
        slider.addChangeListener(this);

        //setting up challenge 5
        openButton.addActionListener(this);

        //freestyle
        String str = "Woah you opened a lot of new windows this message!\nOk, you should stop opening new windows soon, I think the code will brea-";
        textArea.append(str.substring(0, timesOpened));
